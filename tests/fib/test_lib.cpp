...
void test_pt()
{
    ...
    // trace1
    {
        ...
        enum libcsdec_result result = libcsdec_run_ptrix(trace_data_addr, trace_data_size,
            trace_id, memory_map_num, memory_map, local_bitmap, bitmap_size);
